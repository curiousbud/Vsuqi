...
import { ArrowLeft, ShoppingBag } from 'lucide-react'; // Changed Phone to ShoppingBag or similar
  ...
  return (
    <div className="container mx-auto py-12 md:py-16 lg:py-20 px-4 md:px-6 lg:px-8 animate-fadeIn">
      <div className="mb-8 md:mb-12">
        <Link href="/products" className="inline-flex items-center text-xs uppercase tracking-wider text-muted-foreground hover:text-foreground group">
      ...
      <div className="grid md:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-start">
        ...
        <div className="space-y-6 md:space-y-8 animate-fadeInUp animation-delay-200">
          {product.category && (
            <Badge variant="outline" className="text-xs uppercase tracking-wider border-foreground/30 text-foreground/70 px-3 py-1">
              {product.category}
            </Badge>
          )}
